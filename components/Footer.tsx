...
const SOCIALS = [
  { label: "X", icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.263 5.633 5.9-5.633zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg> },
    ...
    <footer className="footer">
      ...
      <div className="footer-body">
        ...
        <div className="footer-cols">
          ...
          <div className="footer-col">
            <h5>Kurumsal</h5>
            {["Hakkımızda", "Belgelerimiz", "Neden Biz?", "Referanslarımız"].map((t) => (
              <Link key={t} href="/hakkimizda">{t}</Link>
            ))}
          </div>
          <div className="footer-col">
            <h5>Kariyer</h5>
            {["İK Politikamız", "Açık Pozisyonlar", "Başvuru Yap"].map((t) => (
              <Link key={t} href="/iletisim">{t}</Link>
            ))}
          </div>
          <div className="footer-col">
            <h5>İletişim</h5>
            <Link href="tel:+90">+90 XXX XXX XX XX</Link>
            <Link href="mailto:info@sayolmobility.com">info@sayolmobility.com</Link>
